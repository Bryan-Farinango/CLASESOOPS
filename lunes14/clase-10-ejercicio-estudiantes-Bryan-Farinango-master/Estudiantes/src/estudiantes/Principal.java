...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        //programa que lea los datos ingresdos por el usuario
        ...
        Scanner numEst = new Scanner(System.in);
        System.out.println("Ingrese el numero de Estudiantes: " );
        int numeros = numEst.nextInt();
        Estudiantes[] estudiantes = new Estudiantes[numeros];
        for (int i=0; i<estudiantes.length; i++){
            System.out.println("Datos del primer estudiante: " + (i+1));
            System.out.print("Nombre: ");
            Scanner nombreEst = new Scanner(System.in);            
            String nombre;
            nombre = nombreEst.next();
            System.out.print("Apellido: ");
            Scanner apellidoEst = new Scanner(System.in);
            String apellido;
            apellido = apellidoEst.next();
            System.out.print("Cedula: ");
            Scanner numCedula = new Scanner(System.in);
            String cedula;
            cedula = numCedula.next();
        }
        /*
        //--->1ER ESTUDIANTE 
