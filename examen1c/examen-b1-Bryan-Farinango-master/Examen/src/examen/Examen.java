...
public class Examen {
    ...
    public static void main(String[] args) {
        ...
        do{
            //operador terniario ..simplificacion de un if
            /* favorito = (favoritoString.equals("Si") ? true : false);
               favorito = favoritoString.equals("Si");
            es lo mismo que un if
                if ( favoritoString.equals("Si") ){
                    favorito = true;
            {else{
                    favorito = false};
            */
            
            //para cada libro del arreglo libros 
            
            /* for each
                for( Libro libro : libros){
            
            if( libro != null && libro.isFavorito()){
                        sout.out.println(libro.getTitulo();
            }
